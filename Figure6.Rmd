...
# Read in samples 
```{r}
seuratObjS01 <- readRDS("/home/data/path/to/directory/seuratObjS01.rds")
seuratObjS02 <- readRDS("/home/data/path/to/directory/seuratObjS02.rds")
seuratObjS03 <- readRDS("/home/data/path/to/directory/seuratObjS03.rds")
seuratObjS04 <- readRDS("/home/data/path/to/directory/seuratObjS04.rds")
```
# Assign value1
```{r}
...
# Deconvolution2
```{r}
sce <- readRDS("/home/data/path/to/directory/sce.fine.annotated_SCT.rds")
anchors <- readRDS('/home/data/path/to/directory/sce.fine.annotated_SCT_anchors_anchors_Patient01.rds')
...
# Deconvolution2
```{r}
anchors <- readRDS('/home/data/path/to/directory/sce.fine.annotated_SCT_anchors_anchors_Patient02.rds')
...
# Deconvolution2
```{r}
anchors <- readRDS('/home/data/path/to/directory/sce.fine.annotated_SCT_anchors_anchors_Patient03.rds')
...
proportions <- as.data.frame(proportions)
proportions$dominant_fine_labels <- apply(proportions, 1, function(x) names(proportions)[which.max(x)])
write.csv(proportions,'S03proportion_dominant_5Datasets_projected_fine_labels.csv',row.names = T)
...
p_fine <- SpatialPlot(
  ...
  scale_fill_manual(values = custom_colors) +  
  theme(legend.position = "right");p_fine
ggsave('Patient03_InterpretedDominant_fine_Labels.pdf',width=width.ppi,height=height.ppi)
```
# highlight only interested subsets
```{r}
Idents(seuratObjS01) <- "dominant_fine_labels"
...
p_interested <- SpatialPlot(
  ...
  scale_fill_manual(values = custom_colors) +  
  theme(legend.position = "right");p_interested
ggsave('Patient03_InterpretedDominant_fine_Labels_interested_2.pdf',width=width.ppi,height=height.ppi)
...
p <- SpatialFeaturePlot(seuratObj, features = c("B-Plasma.cells", "T.cells","Malignant.cells"), 
                        pt.size.factor = 2, ncol = 3, crop = FALSE, alpha = c(0.1, 1));p
ggsave('Patient03_Dominant_main_Labels.pdf',width=width.ppi*3,height=height.ppi)
```
# spatial visualization
```{r}
seuratObj<- FindSpatiallyVariableFeatures(
...
p2 <- SpatialPlot(seuratObj, group.by = "dominant_celltype",cols = custom_colors_main) + theme(legend.position = "right")
p1 + p2
ggsave('Patient03_Dominant_main_Labels_umap.pdf',width=width.ppi*2,height=height.ppi)
```

# Deconvolution2
```{r}
sce <- readRDS("/home/data/path/to/directory/sce.fine.annotated_SCT.rds")
anchors <- readRDS('/home/data/path/to/directory/sce.fine.annotated_SCT_anchors_anchors_Patient04.rds')
...
proportions <- as.data.frame(proportions)
proportions$dominant_fine_labels <- apply(proportions, 1, function(x) names(proportions)[which.max(x)])
write.csv(proportions,'S04proportion_dominant_fine_labels.csv',row.names = T)
...
p_fine <- SpatialPlot(
  ...
  scale_fill_manual(values = custom_colors) +  
  theme(legend.position = "right");p_fine
ggsave('Patient04_InterpretedDominant_fine_Labels.pdf',width=width.ppi,height=height.ppi)
```
# highlight only interested subsets
```{r}
Idents(seuratObjS01) <- "dominant_fine_labels"
...
p_interested <- SpatialPlot(
  ...
  scale_fill_manual(values = custom_colors) +  
  theme(legend.position = "right");p_interested
ggsave('Patient04_InterpretedDominant_fine_Labels_interest.pdf',width=width.ppi,height=height.ppi)
```
