...
library(scDblFinder)
library(dplyr)
Bcell <- readRDS("/home/data/path/to/directory/Bcell.rds")
...
# Figure 5C
```{r}
df <- read.csv("/home/data/path/to/directory/enrichGO_all.csv",
               check.names = FALSE)
...
load("/home/data/path/to/directory/GSEA_result.RData")  
