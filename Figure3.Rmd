...
library(tidyverse)
degs <- readRDS("/home/data/path/to/directory/deg.rds")
...
```{r}
df <- readr::read_csv(
  "/data/path/to/directory/Bcells_GO_BP_cluster_simplified.csv",
...
av <- read.csv("/home/data/path/to/directory/AverageExpression-0.8.csv", 
